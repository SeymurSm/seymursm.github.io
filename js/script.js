$(document).ready(function () {
    ...
    function progressBar1() {
        ...
        context1.beginPath();
        context1.arc(cw, ch, 65, 0, 2 * Math.PI, false);
        context1.fill();
        ...
        context1.beginPath();
        context1.arc(cw, ch, 65, start, diff + start, false);
        context1.stroke();
    ...
    function progressBar2() {
        ...
        context2.beginPath();
        context2.arc(cw, ch, 65, 0, 2 * Math.PI, false);
        context2.fill();
        ...
        context2.beginPath();
        context2.arc(cw, ch, 65, start, diff + start, false);
        context2.stroke();
    ...
    function progressBar3() {
        ...
        context3.beginPath();
        context3.arc(cw, ch, 65, 0, 2 * Math.PI, false);
        context3.fill();
        ...
        context3.beginPath();
        context3.arc(cw, ch, 65, start, diff + start, false);
        context3.stroke();
    ...
    function progressBar4() {
        ...
        context4.beginPath();
        context4.arc(cw, ch, 65, 0, 2 * Math.PI, false);
        context4.fill();
        ...
        context4.beginPath();
        context4.arc(cw, ch, 65, start, diff + start, false);
        context4.stroke();
